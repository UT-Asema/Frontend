...
function Middle () {
  ...
  return (
    <div className="h-screen w-screen flex justify-center">
      ...
      <body>
        <div className="">
        <h2 className="text-3xl font-semibol font-serif flex justify-start bg-[#1C142B] text-[#E2E8F0] rounded-xl p-6 w-fit text-center"><i class="fa-solid fa-fire p-1 text-[#FF9601]"></i>  Endorsed</h2>
